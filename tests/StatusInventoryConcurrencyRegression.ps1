param(
    ...
    [string]$OutputDirectory = (Join-Path $env:TEMP "RAStatusInventoryConcurrencyRegression-$PID")
)
...
$probe = Join-Path $OutputDirectory 'StatusInventoryConcurrencyRegression.exe'
& $compiler /nologo /target:exe /platform:x86 /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:System.Data.dll "/out:$probe" (Join-Path $PSScriptRoot 'StatusInventoryConcurrencyRegression.cs')
